...
interface IReticulumService {
     ...
     */
    String sendLocationTelemetry(in byte[] destHash, String locationJson, in byte[] sourceIdentityPrivateKey, String iconName, String iconFgColor, String iconBgColor);
